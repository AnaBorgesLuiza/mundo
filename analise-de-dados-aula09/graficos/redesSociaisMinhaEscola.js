...
function processarDados(dados) {
    ...
    const valores = ["1441","1425","341","279","245","229","217","174","143","129"]
    const labels = ["índia","china","EUA","inonésia","paquistão","nigéria","brasil","bangladesh","rússia","etiópia"]
    ...
    incluirTexto(`Os países mais populosos do mundo são aqueles que possuem grandes populações absolutas, isto é, detêm um número elevado de habitantes. A população mundial é de 7.794.799.000 de pessoas.`)
}
